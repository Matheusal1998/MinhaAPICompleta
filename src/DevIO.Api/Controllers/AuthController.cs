...
namespace DevIO.Api.Configuration
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(LoginUserViewModel loginUser)
        {
            ...
            NotificarErro("Usuário ou senha inválida");
        ...
        private async Task<LoginResponseViewModel> GerarJwt(string email)
        {
            ...
            claims.Add(new Claim(JwtRegisteredClaimNames.Nbf, ToUnixTime(DateTime.UtcNow).ToString()));
            claims.Add(new Claim(JwtRegisteredClaimNames.Iat, ToUnixTime(DateTime.UtcNow).ToString(), ClaimValueTypes.Integer64));
